...
local scrollerMetatable = {__index = scroller}
...
function scrolling(opt)
  local scroller = {
    ...
    --tracking = false,
    decelerating  = false,
    decelerationRate = type(opt.decelerationRate) == "number" and opt.decelerationRate or 0.94,
    tween = nil, -- content view transition reference
    upperLimit = nil, bottomLimit = nil, -- dynamic scroll limitation
    offsetUpLimit = nil, offsetDownLimit = nil, -- dynamic scroll limitation
    _prevYPos = 0, _prevY = 0,
